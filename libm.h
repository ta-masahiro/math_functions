...
do {                                              \
 ...
 double __sin__(double,double,int);
 double __cos__(double,double);
 double __tan__(double,double,int);
 ...
 long double __sinl__(long double, long double, int);
 long double __cosl__(long double, long double);
 long double __tanl__(long double, long double, int);
